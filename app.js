  ...
  return {
    ...
    addListItem: function(obj, type) {
      ...
      if (type === "inc") {
        ...
        html =
          '<div class="item clearfix" id="inc-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><span class="iconify icn" data-icon="simple-icons:x-pack" data-inline="false"></span></button></div></div></div>';
      } else if (type === "exp") {
        element = DOMstrings.expensesContainer;
        html =
          '<div class="item clearfix"id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><span class="iconify icn" data-icon="simple-icons:x-pack" data-inline="false"></span></button></div></div></div>';
      }
